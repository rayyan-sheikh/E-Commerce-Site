...
const Product = ({product}) => {
  ...
  <div>
    <div className='border border-[#e4e4e4] h-[300px] mb-4 relative overflow-hidden group transition'>
      ...
      {/* buttons */}
      <div className='absolute top-6 -right-11 group-hover:right-5 flex p-2 flex-col items-center justify-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300'>
